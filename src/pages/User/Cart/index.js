                        ...
                        <div style={{ border: '1px solid #F8D5D7' }}>
                            ...
                            <div className='row p-2 w-100 m-0 align-items-center' style={{ borderTop: '1px solid #fff' }} >
                                <div className='col-md-6 d-flex align-items-center'>
                                    <img style={{ width: '108px' }} src='https://product.hstatic.net/200000259653/product/kem-duong-body_132c28acd8e3451bb141261fd12808fa_a295287c6f3a47d4bf94f99f4d0b3ea4_grande.jpg' />
                                    <div style={{ marginLeft: '8px' }}>
                                        <p>Kem dưỡng da mặt phục hồi và chống lão hóa</p>
                                        <button style={{ border: 'none', color: '#c8760b', background: 'none' }}>Xóa</button>
                                    </div>
                                </div>
                                <div className='col-md-2' style={{ color: '#c8760b' }}>2.930.000đ</div>
